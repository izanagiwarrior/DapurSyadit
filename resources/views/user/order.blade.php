            ...
            <div class="row mb-3">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="fill here" name="buyer_name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Address</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="fill here" name="address">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Buyer Contact</label>
                        <input type="text" max="13" class="form-control" id="exampleInputPassword1" placeholder="fill here" name="buyer_contact">
