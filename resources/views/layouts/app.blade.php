        ...
        <div class="container-fluid px-5 m-0">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class=" navbar-nav ms-auto d-flex justify-content-between"> 
                        <a class="nav-item nav-link" href="{{ route('orderList') }}">
                            History
                        </a>
                        ...
                        <a href="{{ route('cart') }}" class="nav-item nav-link"><img src="{{asset('icons/shopping-bag.svg')}}" width="24px" height="24px" alt="shopping bag"></a>
